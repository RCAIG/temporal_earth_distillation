#!/usr/bin/env bash
# MSM | 12b384 | data ratio 0.2 | 50 epochs
...
model_id="${MODEL_ID:-MSM-12b384d6h-data02-noImp-noLonLat-noMissingMaskEmbed-reg4-vs05-ep50-ablation}"
...
echo "[MSM 12b384 data02 ep50] model_id=$model_id reg=$n_storage_tokens ratio=$train_data_ratio epochs=$train_epochs filter=$valid_sample_threshold use_missing_mask_embed=$use_missing_mask_embed"
